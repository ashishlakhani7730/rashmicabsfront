		...
		<section id="content" class="gray-area">
            <div class="container">
				...
				<div class="alert alert-success">
                        Multicity Cab Booked Successfully
					...
					<div class="sidebar col-sm-4 col-md-3">
							...
							<article class="detailed-logo">
								...
								<div class="details">
									...
									<?php if($ticketdetail['b_advance'] == 0) { ?>
									<span class="price clearfix">
										<small class="pull-left">Total Paid</small>
										<span class="pull-right">CASH TO RASHMICABS</span>
									</span>
									<?php } else { ?>
										<span class="price clearfix">
										<small class="pull-left">Total Paid</small>
										<span class="pull-right">INR. <?php echo $ticketdetail['adavancepaid']; ?></span>
									</span>
								     <?php } ?>
                    ...
                    <div id="main" class="col-sm-8 col-md-9">
                        <div class="booking-information travelo-box">
                            ...
                            <dl class="term-description">
                                ...
                                <?php if($ticketdetail['b_advance'] == 0) { ?>
							    <dt>Payment Details:</dt><dd>CASH TO RASHMICABS</dd>
								<?php } else { ?>
                                <dt>Payment Details:</dt><dd>Rs. <?php echo $ticketdetail['adavancepaid']; ?> Paid via online</dd>
                                <?php } ?>
                            </dl>
                            <hr />
                            <div class="row">
                             <div class="intro box table-wrapper full-width hidden-table-sms">
									...
									<dt class="feature">Minimum Km.:</dt><dd class="value">Km.<?php echo $ticketdetail['minikm'];?></dd>
									<dt class="feature">Extra Rate Per Km.:</dt><dd class="value">Rs.<?php echo $ticketdetail['ratekm'];?></dd>
									<dt class="feature">Minimum Hr.:</dt><dd class="value">Hr.<?php echo $ticketdetail['minihr'];?></dd>
