		...
		<div class="page-title-container">
            ...
            <div class="container">
                ...
                <div class="page-title pull-left">
                    ...
                    <h2 class="entry-title"><?php if(isset($fromcity) && $fromcity != '') { echo $fromcity; } ?> <?php if(isset($fromcity) && $fromcity != '') { echo " - "; } ?>  LOCAL  <?php if(isset($date) && $date != "") { echo $date; }?></h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-md-3">
							...
							<div class="panel style1 arrow-right">
                                    ...
                                    <div id="modify-search-panel" class="panel-collapse in">
                                        ...
                                        <div class="panel-content">
                                            ...
                                            <form action="<?php echo site_url("lists/localcablists"); ?>" method="post">
												...
												<div class="form-group col-sm-12 col-md-12">
													...
													<h4 class="title">Package Type</h4>

												 <div class="radio_type">

												   <label class="radio radio-inline" style="color:black">

														<input type="radio" name="filter" value="5" checked="checked" />
													...
													<label class="radio radio-inline" style="color:black">
														...
														<input type="radio" value="6" name="filter" />
													...
													<label class="radio radio-inline" style="color:black">
														...
														<input type="radio" value="7" name="filter" />
												...
												<div class="form-group">
                                                    ...
                                                    <select id="local_from_city" name="local_from_city" class="form-control full-width select2" required>
											...
											<?php } ?>  
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="datepicker-wrap">
                                                        ...
                                                        <input type="text" name="local_date_from" class="input-text full-width" placeholder="mm/dd/yyyy" required/>
                                               ...
                                               <div class="form-group">
                                                ...
                                                <div class="selector">                                               
														...
														<select id="localtime" name="localtime" class="full-width" >
                          ...
                          <div class="col-sm-8 col-md-9">
                            ...
                            <form id="xmldatafo" name="xmldatafo" action="<?php echo site_url("cablocalway/checkout"); ?>" method="post">
								...
								<input type="hidden" name="sub_type_id" value="<?php if(isset($sub_type_id) && $sub_type_id != "") { echo $sub_type_id; }?>">
											...
											<div class="row">
												...
												<form action="#" class="horizontal-form">
													...
													<div class="col-md-6">
														...
														<h4><b>Package Rate:</b></h4>

													</div>

													<div class="col-md-6">

														<h4><?php echo $cab['price']; ?> KM</h4>
...
tjq('#book').click(function() {
...

   {
	   ...
	   tjq.ajax({
			...
			url: '<?php echo site_url('localcabs/bookcab'); ?>',
