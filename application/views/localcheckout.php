		...
		<div class="page-title-container">
            <div class="container">
                <div class="page-title pull-left">
                    <h2 class="entry-title"><?php if(isset($fromcity) && $fromcity != '') { echo $fromcity; } ?><?php if(isset($fromcity) && $fromcity != '') { echo " - "; } ?> LOCAL <?php if(isset($date) && $date != '') { echo " - "; } ?><?php if(isset($date) && $date != "") { echo $date; }?></h2>
                </div>
                <ul class="breadcrumbs pull-right">
                    <li><a href="<?php echo base_url(); ?>">GO TO HOME</a></li>   
					<li><a href="<?php echo site_url('lists/onewaycablists'); ?>">Cab List</a></li>
				...
				<?php } ?>
                        ...
                        <div class="booking-details travelo-box">
                            ...
                            <article class="flight-booking-details">
                                <div class="travel-title">
                                    <h5 class="box-title"><?php echo $package_detail['category_name']."-". $package_detail['vehicle_name']; ?><small>ONEWAY</small></h5>
                                </div>                                              
                            </article>                       
                            <h4>Other Details</h4>
                    ...
                    <div id="main" class="col-sms-6 col-sm-8 col-md-9">
                        <div class="booking-section travelo-box">
                            ...
                            <form id="checkoutdetail" action="<?php echo site_url("cabs/localoffline");?>" name="checkoutdetail" class="booking-form" method="post">
                            <?php } else { ?>
							...
							<?php } ?>
							   <input type="hidden" name="xmldataparser" value="<?php echo $this->security->get_csrf_hash(); ?>">
								...
								<input type="hidden" name="fromcitys" value="<?php if(isset($fromcitys) && $fromcitys != '') { echo $fromcitys; } ?>">
								...
								<input type="hidden" name="time" value="<?php if(isset($time) && $time != "") { echo $time; }?>">
                                ...
                                <div class="form-group row">
										...
										<div class="col-sm-6 col-md-10">
											...
											<?php if($package_detail['total_advance_rate'] == 0) { ?>
                                            <input type="text" class="input-text full-width" value="CASH TO RASHMICABS" placeholder="" disabled="disabled" />
											<?php } else { ?>
	    ...
	    messages: {
			...
			pickup_point: {
	        		required: "Please Enter Pickup Point",
			  		regx1: "Please Select Valid Pickup Point",
			},
			drop_point: {
	        		required: "Please Enter Pickup Point",
			  		regx1: "Please Select Valid Pickup Point",
