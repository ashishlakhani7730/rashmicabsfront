		...
		<div class="page-title-container">
            <div class="container">
                <div class="page-title pull-left">
                    <h2 class="entry-title"><?php if(isset($fromcity) && $fromcity != '') { echo $fromcity; } ?><?php if(isset($fromcity) && $fromcity != '') { echo " - "; } ?><?php if(isset($tocity) && $tocity != '') { echo $tocity; } ?><?php if(isset($tocity) && $tocity != '') { echo " - "; } ?>ONEWAY<?php if(isset($date) && $date != '') { echo " - "; } ?><?php if(isset($date) && $date != "") { echo $date; }?></h2>
                </div>
				...
				<?php } ?>
                    ...
                    <div id="main" class="col-sms-6 col-sm-8 col-md-9">
                        <div class="booking-section travelo-box">
                            ...
                            <form id="checkoutdetail" action="<?php echo site_url("cabs/onewayoffline");?>" name="checkoutdetail" class="booking-form" method="post">
                            <?php } else { ?>
