		...
		<div class="page-title-container">
            ...
            <div class="container">
                ...
                <div class="page-title pull-left">
                    ...
                    <h2 class="entry-title"><?php if(isset($fromcity) && $fromcity != '') { echo $fromcity; } ?> <?php if(isset($fromcity) && $fromcity != '') { echo " - "; } ?> <?php if(isset($tocity) && $tocity != '') { echo $tocity; } ?> <?php if(isset($tocity) && $tocity != '') { echo " - "; } ?> ROUNDTRIP <?php if(isset($date1) && $date1 != '') { echo " - "; } ?> <?php if(isset($date1) && $date1 != "") { echo $date1; }?><?php if(isset($date2) && $date2 != '') { echo " - "; } ?> <?php if(isset($date2) && $date2 != "") { echo $date2; }?></h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-md-3">
							...
							<div class="panel style1 arrow-right">
                                    ...
                                    <div id="modify-search-panel" class="panel-collapse in">
                                        ...
                                        <div class="panel-content">
                                            ...
                                            <form action="<?php echo site_url("lists/roundcablists"); ?>" method="post">
                          ...
                          <div class="col-sm-8 col-md-9">
                            ...
                            <form id="xmldatafo" name="xmldatafo" action="<?php echo site_url("cabroundway/checkout"); ?>" method="post">
								...
								<input type="hidden" name="tocitys" value="<?php if(isset($tocitys) && $tocitys != '') { echo $tocitys; } ?>">

								<input type="hidden" name="date1" value="<?php if(isset($date1) && $date1 != "") { echo $date1; }?>">

								<input type="hidden" name="date2" value="<?php if(isset($date2) && $date2 != "") { echo $date2; }?>">
...
tjq('#book').click(function() {
...

   {
	   ...
	   var fcity = "<?php if(isset($fromcityid) && $fromcityid != "") { echo $fromcityid; }?>";

	   var tcity = "<?php if(isset($tocitys) && $tocitys != "") { echo $tocitys; }?>";

	   var fdate = "<?php if(isset($date1) && $date1 != "") { echo $date1; }?>";

	   var rdate = "<?php if(isset($date2) && $date2 != "") { echo $date2; }?>";

	   var stime = "<?php if(isset($fromtime) && $fromtime != "") { echo $fromtime; }?>";

	   

	   tjq.ajax({

			url: '<?php echo site_url('roundtrip/bookcab'); ?>',
