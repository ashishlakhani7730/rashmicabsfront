		...
		<div class="page-title-container">
            <div class="container">
                ...
                <ul class="breadcrumbs pull-right">
					...
					<li><a href="<?php echo site_url('lists/cablists'); ?>">Cab List</a></li>
                ...
                <div class="row">
                        ...
                        <div class="booking-details travelo-box">
                            ...
                            <article class="flight-booking-details">
                                <div class="travel-title">
                                    <h5 class="box-title"><?php echo $package_detail['category_name']."-". $package_detail['vehicle_name']; ?><small>ONEWAY OFFER</small></h5>
                                </div>
                                ...
                                <div class="details">
                                    <div class="constant-column-3 timing clearfix">
                                        <div class="check-in">
                                            ...
                                            <span><?php echo date('h:i A',strtotime($package_detail['valid_from_time'])); ?></span>
                                        </div>
                                        ...
                                        <div class="check-out">
                                            ...
                                            <span><?php echo date('h:i A',strtotime($package_detail['valid_to_time'])); ?></span>
                                        </div>
                                    </div>
                                </div>
                            </article>                       
                            ...
                            <dl class="other-details">
								...
								<dt class="feature">Estimated Time:</dt><dd class="value">Hr. <?php echo $package_detail['total_time']; ?></dd>
                                <dt class="feature">Number Of Seat:</dt><dd class="value"><?php echo $package_detail['no_of_seats'];?></dd>							
                                <dt class="feature">Estimated Total:</dt><dd class="value">Rs. <?php echo $package_detail['total_estimated_rate']; ?></dd>
                    ...
                    <div id="main" class="col-sms-6 col-sm-8 col-md-9">
                        <div class="booking-section travelo-box">
                            ...
                            <form id="checkoutdetail" name="checkoutdetail" class="booking-form" method="post">
                                ...
                                <div class="card-information">
                                    <h2>Trip Details</h2>
									<div class="form-group row">
										<div class="col-sm-10 col-md-10 chk">
											<label>Trip Start Time</label>
                                                <div class="selector">
                                                    <select id="triptime" name="triptime" class="full-width">
	...
	var self;
		...
		tjq("#checkoutpro").on('click',function(){
			...
			else
			{
				...
				var selfstatus = tjq('#selfs').val();
				var fcity = "<?php echo $fromcityid; ?>";
				var tcity = "<?php echo $tocityid; ?>";
				var date = "<?php echo $date; ?>";
				
				tjq.ajax({
						url: '<?php echo site_url('onewayoffer/checkout'); ?>',
						headers: {'X-Powered-By': 'ASP.NET','Authorization':'RASHMIxxxxxxxxxxxxx9'},
						method: 'post',
						//dataType:"json",
						data: {'xmldataparser':'<?php echo $this->security->get_csrf_hash(); ?>',fname:fname,lname:lname,email:email,mobile:mobile,tname:tname,tphone:tphone,triptime:triptime,pickup_point:pickup_point,drop_point:drop_point,note:note,xmldata:xmldata,selfstatus:selfstatus,fcity:fcity,tcity:tcity,date:date},
	...
	jQuery.validator.addMethod("valueNotEquals", function(value, element, valueNotEqual){
	  ...
	  tjq("form[name='checkoutdetail']").validate({
	    ...
	    rules: {
		  ...
		  triptime:{ valueNotEquals: "default" },
		  agree:{required: true}
	    ...
	    messages: {
			...
			triptime:{ valueNotEquals: "Please Select Trip Start Time" },
